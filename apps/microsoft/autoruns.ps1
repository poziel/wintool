...
# irm https://raw.githubusercontent.com/poziel/wintool/refs/heads/master/apps/autoruns.ps1 | iex

# To create a shortcut for Autoruns by Microsoft, execute the following line in PowerShell:
# $shortcut = (New-Object -ComObject WScript.Shell).CreateShortcut((Join-Path -Path (Get-Location) -ChildPath "Microsoft - Autoruns.lnk")); $shortcut.TargetPath = "%windir%\System32\WindowsPowerShell\v1.0\powershell.exe"; $shortcut.Arguments = "-ExecutionPolicy Bypass -Command `"Start-Process powershell.exe -verb runas -ArgumentList 'irm https://raw.githubusercontent.com/poziel/wintool/refs/heads/master/apps/microsoft/autoruns.ps1 | iex'`""; $shortcut.WorkingDirectory = "%windir%\System32\WindowsPowerShell\v1.0"; $shortcut.Description = "Autoruns by Microsoft is a utility for managing Windows startup items, offering control over programs and services that run automatically."; $shortcut.Save()
