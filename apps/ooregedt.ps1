...
# irm https://raw.githubusercontent.com/poziel/wintool/refs/heads/master/apps/ooregedt.ps1 | iex

# To create a shortcut for O&O RegEditor, execute the following line in PowerShell:
# $shortcut = (New-Object -ComObject WScript.Shell).CreateShortcut((Join-Path -Path (Get-Location) -ChildPath "O&O - RegEditor.lnk")); $shortcut.TargetPath = "%windir%\System32\WindowsPowerShell\v1.0\powershell.exe"; $shortcut.Arguments = "-ExecutionPolicy Bypass -Command `"Start-Process powershell.exe -verb runas -ArgumentList 'irm https://raw.githubusercontent.com/poziel/wintool/refs/heads/master/apps/ooregedt.ps1 | iex'`""; $shortcut.WorkingDirectory = "%windir%\System32\WindowsPowerShell\v1.0"; $shortcut.Description = "O&O RegEditor is a powerful alternative to the default Windows registry editor, offering advanced features for easier registry management."; $shortcut.Save()
