...
# irm https://raw.githubusercontent.com/poziel/wintool/refs/heads/master/apps/optimizer.ps1 | iex

# To create a shortcut for Optimizer by Hellzerg, execute the following line in PowerShell:
# $shortcut = (New-Object -ComObject WScript.Shell).CreateShortcut((Join-Path -Path (Get-Location) -ChildPath "Hellzerg - Optimizer.lnk")); $shortcut.TargetPath = "%windir%\System32\WindowsPowerShell\v1.0\powershell.exe"; $shortcut.Arguments = "-ExecutionPolicy Bypass -Command `"Start-Process powershell.exe -verb runas -ArgumentList 'irm https://raw.githubusercontent.com/poziel/wintool/refs/heads/master/apps/optimizer.ps1 | iex'`""; $shortcut.WorkingDirectory = "%windir%\System32\WindowsPowerShell\v1.0"; $shortcut.Description = "Optimizer by Hellzerg is a tool for enhancing Windows privacy, removing bloatware, and optimizing performance."; $shortcut.Save()
