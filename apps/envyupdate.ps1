...
# irm https://raw.githubusercontent.com/poziel/wintool/refs/heads/master/apps/envyupdate.ps1 | iex

# To create a shortcut for EnvyUpdate, execute the following line in PowerShell:
# $shortcut = (New-Object -ComObject WScript.Shell).CreateShortcut((Join-Path -Path (Get-Location) -ChildPath "EnvyUpdate.lnk")); $shortcut.TargetPath = "%windir%\System32\WindowsPowerShell\v1.0\powershell.exe"; $shortcut.Arguments = "-ExecutionPolicy Bypass -Command `"Start-Process powershell.exe -verb runas -ArgumentList 'irm https://raw.githubusercontent.com/poziel/wintool/refs/heads/master/apps/envyupdate.ps1 | iex'`""; $shortcut.WorkingDirectory = "%windir%\System32\WindowsPowerShell\v1.0"; $shortcut.Description = "EnvyUpdate is a PowerShell tool that automates downloading and installing the latest NVIDIA graphics drivers."; $shortcut.Save()
